...
public class DrawScreen extends JPanel {
    ...
    public void init() {
        ...
        Util.keybind(this, KeyEvent.VK_W, "up", ac[0] = Util.actionMaker(u -> {
            gameplay.move[0] = true;
        }));
        Util.keybind(this, KeyEvent.VK_S, "down", ac[1] = Util.actionMaker(u -> {
            gameplay.move[1] = true;
        }));
        Util.keybind(this, KeyEvent.VK_D, "right", ac[2] = Util.actionMaker(u -> {
            gameplay.move[2] = true;
        }));
        Util.keybind(this, KeyEvent.VK_A, "left", ac[3] = Util.actionMaker(u -> {
            gameplay.move[3] = true;
        }));
        Util.keybind(this, KeyEvent.VK_UP, "uparrow", ac[4] = Util.actionMaker(u -> {
            gameplay.move[4] = true;
        }));
        Util.keybind(this, KeyEvent.VK_DOWN, "downarrow", ac[5] = Util.actionMaker(u -> {
            gameplay.move[5] = true;
        }));
        Util.keybind(this, KeyEvent.VK_RIGHT, "rightarrow", ac[6] = Util.actionMaker(u -> {
            gameplay.move[6] = true;
        }));
        Util.keybind(this, KeyEvent.VK_LEFT, "leftarrow", ac[7] = Util.actionMaker(u -> {
            gameplay.move[7] = true;
        }));
        Util.keybind(this, KeyEvent.VK_W, "up1", ac[8] = Util.actionMaker(u -> {
            gameplay.move[0] = false;
        }), true);
        Util.keybind(this, KeyEvent.VK_S, "down1", ac[9] = Util.actionMaker(u -> {
            gameplay.move[1] = false;
        }), true);
        Util.keybind(this, KeyEvent.VK_D, "right1", ac[10] = Util.actionMaker(u -> {
            gameplay.move[2] = false;
        }), true);
        Util.keybind(this, KeyEvent.VK_A, "left1", ac[11] = Util.actionMaker(u -> {
            gameplay.move[3] = false;
        }), true);
        Util.keybind(this, KeyEvent.VK_UP, "uparrow1", ac[12] = Util.actionMaker(u -> {
            gameplay.move[4] = false;
        }), true);
        Util.keybind(this, KeyEvent.VK_DOWN, "downarrow1", ac[13] = Util.actionMaker(u -> {
            gameplay.move[5] = false;
        }), true);
        Util.keybind(this, KeyEvent.VK_RIGHT, "rightarrow1", ac[14] = Util.actionMaker(u -> {
            gameplay.move[6] = false;
        }), true);
        Util.keybind(this, KeyEvent.VK_LEFT, "leftarrow1", ac[15] = Util.actionMaker(u -> {
            gameplay.move[7] = false;
        }), true);
    }
    ...
    private void drawObjects(Graphics g) {
        if (!gameOver) {
            ...
            for (int i = 0; i < gameplay.maze.x; i++)
                for (int j = 0; j < gameplay.maze.y; j++) {
